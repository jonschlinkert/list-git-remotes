# Contributing to list-git-remotes

First and foremost, thank you! We appreciate that you want to contribute to list-git-remotes, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for list-git-remotes**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for list-git-remotes:

- star the [project](https://github.com/jonschlinkert/list-git-remotes)
- tweet your support for list-git-remotes
...
- **version**: please note the version of list-git-remotes are you using
...
[so]: http://stackoverflow.com/questions/tagged/list-git-remotes